<section class="py-16">
    <div class="container mx-auto text-center">
        ...
        <div class="flex flex-col md:flex-row justify-center mt-12 space-y-6 md:space-y-0 md:space-x-4">
        <!-- Elemento de Precio 1 -->
            <div class="bg-white p-6 rounded-lg shadow-lg text-center mx-10 md:mx-0">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg text-center mt-6 md:mt-0 mx-10">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg text-center mt-6 md:mt-0 relative mx-10 md:mx-0">
                ...
                <div class="absolute -top-3 -right-5 bg-yellow-500 text-white text-sm py-1 px-4 rounded-full shadow-md uppercase">
